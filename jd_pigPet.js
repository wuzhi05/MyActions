...
!(async () => {
  ...
  let res2 = await getAuthorShareCode('https://raw.githubusercontent.com/wuzhi05/updateTeam/master/shareCodes/pigPet.json')
  if (!res2) {
    ...
    await $.wait(2000)
    res2 = await getAuthorShareCode('https://cdn.jsdelivr.net/gh/wuzhi05/updateTeam@master/shareCodes/pigPet.json')
  }
  $.shareCodes = [...new Set([...(res2 || []), ...$.shareCodes])]
