...
async function run(type = 0){
  try{
    ...
    rebateCodes = $.isNode() ? (process.env.gua_nhjRed_rebateCode ? process.env.gua_nhjRed_rebateCode : `${rebateCodes}`) : ($.getdata('jd_nhjRed_rebateCode') ? $.getdata('jd_nhjRed_rebateCode') : `${rebateCodes}`);
